      ...
      <tr>
        <td>
          <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
              <td style="font-family: 'Poppins', 'Sans-serif'; font-size: 30px; background-color: whitesmoke; color: gold; font-weight: 700; letter-spacing: 2px; width: 100%; text-align: center;">
                <span style="color: #08349c;">NoteWave</span>
              </td>
            </tr>
          </table>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #08349c; color: white;">
            ...
            <tr>
              <td style="letter-spacing: 2px; font-size: 15px; text-transform: uppercase; text-align: center; padding: 15px 0;">Thanks for signing up!</td>
            </tr>
          </table>
          
          <table width="100%" cellpadding="0" cellspacing="0" border="0" style="padding: 0 10px;">
            <tr>
              <td style="font-size: 20px; text-align: center; padding: 15px 0;">Congratulations! 🎉</td>
            </tr>
            <tr>
              <td style="text-align: center; padding: 15px 0;"> Your account is now verified and ready to roll! Please click on the button below to go back to the website and explore the modern note-taking experience</td>
            </tr>
            <tr>
